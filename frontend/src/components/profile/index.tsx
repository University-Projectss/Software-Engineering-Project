            ...
            <Grid templateColumns="repeat(2, 1fr)" gap={6} p={8}>
                <GridItem colSpan={1}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <FormField label="Full Name" input={profile.fullName} type="string" />
                        <FormField label="Email" input={profile.email} type="string" />

                        <br></br>
                        <br></br>

                        <FormField label="Date of Birth" input={profile.dateOfBirth} type="string" />
                        ...
                        <FormField label="Known Diseases" input={profile.knownDiseases} type="string" />
                        <FormField label="Allergies" input={profile.allergies} type="string" />
                        <FormField label="Past Surgeries" input={profile.pastSurgeries} type="string" />
                        <FormField label="Current Medications" input={profile.currentMedications} type="string" />

                    </form>
                </GridItem>

                {/* Image and submit/logout button - right half */}
                <GridItem colStart={2} display="flex" flexDirection="column" alignItems="flex-end" justifyContent="flex-end">
